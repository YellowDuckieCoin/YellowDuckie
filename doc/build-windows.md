...
Below are some notes on how to build YellowDuckieCoin Core for Windows.
...
way. This will install to `c:\workspace\yellowduckiecoin`, for example:

    make install DESTDIR=/mnt/c/workspace/yellowduckiecoin
