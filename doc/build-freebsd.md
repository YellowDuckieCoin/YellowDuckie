Build instructions for YellowDuckieCoin 
=================================
FreeBSD 13.0
---------------------------------
...
Directory structure
------------------
YellowDuckieCoin sources in `$HOME/src`
...
__Download YellowDuckieCoin source.__
...
You can now start yellowduckiecoin-qt from the build directory.

`src/qt/yellowduckiecoin-qt`

yellowduckiecoind and yellowduckiecoin-cli are in `src/`
