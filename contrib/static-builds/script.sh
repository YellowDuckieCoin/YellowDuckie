...
DISTNAME=yellowduckiecoin-2.0.3
MAKEOPTS="-j4"
BRANCH=master
clear
if [[ $EUID -ne 0 ]]; then
...
rm -rf ~/YellowDuckieCoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../YellowDuckieCoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../YellowDuckieCoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/YellowDuckieCoin/temp
cd ~/YellowDuckieCoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/YellowDuckieCoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/YellowDuckieCoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
