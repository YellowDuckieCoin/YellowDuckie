...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the YellowDuckieCoin repository."
  exit 1
fi
...
echo 'When compiling YellowDuckieCoin, run `./configure` in the following way:'
echo
