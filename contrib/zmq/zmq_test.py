...
"""
    ...
    YellowDuckieCoin should be started with the command line arguments:
        yellowduckiecoind -testnet -daemon \
...
print("Getting YellowDuckieCoin msgs")
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND YD issuance at " + str(pos))
				print("After YD: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND YD something at " + str(pos))
			start += pos+8
			print(astr)
