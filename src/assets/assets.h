...
#ifndef YellowDuckieCoin_ASSET_PROTOCOL_H
#define YellowDuckieCoin_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_YellowDuckieCoin_ASSET YDQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_YellowDuckieCoin_ASSET YDO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_YellowDuckieCoin_ASSET YDR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_YellowDuckieCoin_ASSET YDT
...
#endif //YellowDuckieCoin_ASSET_PROTOCOL_H
