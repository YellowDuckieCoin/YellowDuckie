// Copyright (c) 2018-2020 The YellowDuckieCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.


#ifndef YellowDuckieCoin_MESSAGES_H
#define YellowDuckieCoin_MESSAGES_H
...
#endif //YellowDuckieCoin_MESSAGES_H
