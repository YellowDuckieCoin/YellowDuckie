// Copyright (c) 2019 The YellowDuckieCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef YellowDuckieCoin_NEWASSET_H
#define YellowDuckieCoin_NEWASSET_H
...
{
public:
    std::string strName; // MAX 256 Bytes
...
#endif //YellowDuckieCoin_NEWASSET_H
