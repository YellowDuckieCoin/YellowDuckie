...
#ifndef YellowDuckieCoin_CHAINPARAMS_H
#define YellowDuckieCoin_CHAINPARAMS_H
 ...
 * YellowDuckieCoin system. There are three: the main network on which people trade goods
...
#endif // YellowDuckieCoin_CHAINPARAMS_H
