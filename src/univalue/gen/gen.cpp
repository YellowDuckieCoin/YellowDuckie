...
static void outputEscape()
{
	printf(	"// Automatically generated file. Do not modify.\n"
		"#ifndef YellowDuckieCoin_UNIVALUE_UNIVALUE_ESCAPES_H\n"
		"#define YellowDuckieCoin_UNIVALUE_UNIVALUE_ESCAPES_H\n"
	...
	printf(	"};\n"
		"#endif // YellowDuckieCoin_UNIVALUE_UNIVALUE_ESCAPES_H\n");
}
