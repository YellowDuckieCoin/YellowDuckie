...
#ifndef YellowDuckieCoin_VALIDATION_H
#define YellowDuckieCoin_VALIDATION_H
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for yellowduckiecoin, with 1 minutes block intervals?
...
#endif // YellowDuckieCoin_VALIDATION_H
