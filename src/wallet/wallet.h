...
#ifndef YellowDuckieCoin_WALLET_WALLET_H
#define YellowDuckieCoin_WALLET_WALLET_H
...
public:
     ...
     * on this yellowduckiecoin node, and set to 0 for transactions that were created
...
public:
    ...
    void AvailableCoinsAll(std::vector<COutput>& vCoins, std::map<std::string, std::vector<COutput> >& mapAssetCoins,
                            bool fGetYD = true, bool fOnlyAssets = false,
    ...
    /**
     * Helper function that calls AvailableCoinsAll, used to receive all coins, Assets and YD
     */
...
#endif // YellowDuckieCoin_WALLET_WALLET_H
