...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        CScript ydTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut ydOut(1*COIN, ydTransfer);
        ...
        mutTxTest1.vout.emplace_back(ydOut);
        ...
        mutTxTest2.vout.emplace_back(ydOut);
        ...
        mutTxTest3.vout.emplace_back(ydOut);
        ...
        mutTxTest4.vout.emplace_back(ydOut);
        ...
        mutTxTest5.vout.emplace_back(ydOut);
        ...
        mutTxTest6.vout.emplace_back(ydOut);
        ...
        mutTxTest7.vout.emplace_back(ydOut);
        ...
        mutTxTest8.vout.emplace_back(ydOut);
