...
#ifndef YellowDuckieCoin_TEST_SCRIPTNUM10_H
#define YellowDuckieCoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from YellowDuckieCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // YellowDuckieCoin_TEST_BIGNUM_H
