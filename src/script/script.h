...
#ifndef YellowDuckieCoin_SCRIPT_SCRIPT_H
#define YellowDuckieCoin_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, YellowDuckieCoin always counted CHECKMULTISIGs
...
#endif // YellowDuckieCoin_SCRIPT_SCRIPT_H
