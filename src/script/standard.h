...
#ifndef YellowDuckieCoin_SCRIPT_STANDARD_H
#define YellowDuckieCoin_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_YellowDuckieCoin_ASSET script that carries data
    /** YD END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a YellowDuckieCoin address
 */
...
/**
 * Generate a YellowDuckieCoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // YellowDuckieCoin_SCRIPT_STANDARD_H
