...
CAmount AmountFromValue(const UniValue& value, bool p_isYD)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "YellowDuckieCoin server stopping";
}
...
{
    return "> yellowduckiecoin-cli " + methodname + " " + args + "\n";
}
