 ...
 */
#ifndef YellowDuckieCoin_UTIL_H
#define YellowDuckieCoin_UTIL_H
...
extern const char *const YellowDuckieCoin_CONF_FILENAME;
extern const char *const YellowDuckieCoin_PID_FILENAME;
...
{
    std::string s = strprintf("yellowduckiecoin-%s", name);
