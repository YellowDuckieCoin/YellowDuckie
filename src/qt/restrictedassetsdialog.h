...
#ifndef YellowDuckieCoin_QT_RESTRICTEDASSETSDIALOG_H
#define YellowDuckieCoin_QT_RESTRICTEDASSETSDIALOG_H
...
/** Dialog for sending yellowduckiecoins */
...
#endif // YellowDuckieCoin_QT_RESTRICTEDASSETSSDIALOG_H
