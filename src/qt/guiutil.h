...
#ifndef YellowDuckieCoin_QT_GUIUTIL_H
#define YellowDuckieCoin_QT_GUIUTIL_H
...
/** Utility functions used by the YellowDuckieCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "yellowduckiecoin:" URI into recipient object, return true on successful parsing
...
#endif // YellowDuckieCoin_QT_GUIUTIL_H
