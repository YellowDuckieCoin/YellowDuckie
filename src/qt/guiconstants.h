...
#ifndef YellowDuckieCoin_QT_GUICONSTANTS_H
#define YellowDuckieCoin_QT_GUICONSTANTS_H
...
/* YellowDuckieCoinGUI -- Size of icons in status bar */
...
/* YellowDuckieCoin dark orange */
#define COLOR_DARK_ORANGE QColor("#f05239")
/* YellowDuckieCoin light orange */
#define COLOR_LIGHT_ORANGE QColor("#f79433")
/* YellowDuckieCoin dark blue */
#define COLOR_DARK_BLUE QColor("#384192")
/* YellowDuckieCoin light blue */
#define COLOR_LIGHT_BLUE QColor("#5874cf")
/* YellowDuckieCoin asset text */
#define COLOR_ASSET_TEXT QColor(255, 255, 255)
/* YellowDuckieCoin shadow color - light mode */
...
/* YellowDuckieCoin shadow color - dark mode */
#define COLOR_SHADOW_DARK QColor("#0c1b3d")
/* YellowDuckieCoin Light blue - dark mode - dark mode */
#define COLOR_LIGHT_BLUE_DARK QColor("#1e2636")
/* YellowDuckieCoin Dark blue - dark mode - dark mode */
#define COLOR_DARK_BLUE_DARK QColor("#0b1018")
/* Pricing widget background color */
#define COLOR_PRICING_WIDGET QColor("#161e2d")
/* YellowDuckieCoin dark mode administrator background color */
#define COLOR_ADMIN_CARD_DARK COLOR_BLACK
/* YellowDuckieCoin dark mode regular asset background color */
...
/* YellowDuckieCoin label color as a string */
...
#define QAPP_ORG_NAME "YellowDuckieCoin"
#define QAPP_ORG_DOMAIN "yellowduckie.net"
#define QAPP_APP_NAME_DEFAULT "YellowDuckieCoin-Qt"
#define QAPP_APP_NAME_TESTNET "YellowDuckieCoin-Qt-testnet"

/* Default third party browser urls */
#define DEFAULT_THIRD_PARTY_BROWSERS "https://explorer.yellowduckie.net/tx/%s"

/* Default IPFS viewer */
#define DEFAULT_IPFS_VIEWER "https://ipfs.io/ipfs/%s"

#endif // YellowDuckieCoin_QT_GUICONSTANTS_H
