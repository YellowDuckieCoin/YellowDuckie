...
#ifndef YellowDuckieCoin_QT_RECEIVECOINSDIALOG_H
#define YellowDuckieCoin_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of yellowduckiecoins */
...
#endif // YellowDuckieCoin_QT_RECEIVECOINSDIALOG_H
