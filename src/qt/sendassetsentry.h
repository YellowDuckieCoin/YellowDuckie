...
#ifndef YellowDuckieCoin_QT_SENDASSETSENTRY_H
#define YellowDuckieCoin_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending yellowduckiecoins.
...
#endif // YellowDuckieCoin_QT_SENDASSETSENTRY_H
