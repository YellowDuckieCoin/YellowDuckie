...
#ifndef YellowDuckieCoin_QT_OPTIONSDIALOG_H
#define YellowDuckieCoin_QT_OPTIONSDIALOG_H
...
private Q_SLOTS:
    ...
    void on_openYellowDuckieCoinConfButton_clicked();
...
#endif // YellowDuckieCoin_QT_OPTIONSDIALOG_H
