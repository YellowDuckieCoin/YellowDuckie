...
void WalletView::setYellowDuckieCoinGUI(YellowDuckieCoinGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? YellowDuckieCoinGUI::HD44_ENABLED : _walletModel->hdEnabled() ? YellowDuckieCoinGUI::HD_ENABLED : YellowDuckieCoinGUI::HD_DISABLED);
