...
#ifndef YellowDuckieCoin_QT_RPCCONSOLE_H
#define YellowDuckieCoin_QT_RPCCONSOLE_H
...
/** Local YellowDuckieCoin RPC console. */
...
#endif // YellowDuckieCoin_QT_RPCCONSOLE_H
