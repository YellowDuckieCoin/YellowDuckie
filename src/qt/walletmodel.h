...
#ifndef YellowDuckieCoin_QT_WALLETMODEL_H
#define YellowDuckieCoin_QT_WALLETMODEL_H
...
/** Interface to YellowDuckieCoin wallet from Qt view code. */
...
#endif // YellowDuckieCoin_QT_WALLETMODEL_H
