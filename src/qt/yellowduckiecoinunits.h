...
#ifndef YellowDuckieCoin_QT_YellowDuckieCoinUNITS_H
#define YellowDuckieCoin_QT_YellowDuckieCoinUNITS_H
...
/** YellowDuckieCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class YellowDuckieCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit YellowDuckieCoinUnits(QObject *parent);

    /** YellowDuckieCoin units.
...
typedef YellowDuckieCoinUnits::Unit YellowDuckieCoinUnit;

#endif // YellowDuckieCoin_QT_YellowDuckieCoinUNITS_H
