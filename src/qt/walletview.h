...
#ifndef YellowDuckieCoin_QT_WALLETVIEW_H
#define YellowDuckieCoin_QT_WALLETVIEW_H
...
public:
    ...
    void setYellowDuckieCoinGUI(YellowDuckieCoinGUI *gui);
...
#endif // YellowDuckieCoin_QT_WALLETVIEW_H
