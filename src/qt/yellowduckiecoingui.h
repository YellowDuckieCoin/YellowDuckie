...
#ifndef YellowDuckieCoin_QT_YellowDuckieCoinGUI_H
#define YellowDuckieCoin_QT_YellowDuckieCoinGUI_H
...
/**
  YellowDuckieCoin GUI main class. This class represents the main window of the YellowDuckieCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class YellowDuckieCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit YellowDuckieCoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~YellowDuckieCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a yellowduckiecoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // YellowDuckieCoin_QT_YellowDuckieCoinGUI_H
