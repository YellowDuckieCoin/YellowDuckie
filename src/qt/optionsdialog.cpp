    ...
    mapper(0)
{
    ...
    ui->yellowduckiecoinAtStartup->setToolTip(ui->yellowduckiecoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->yellowduckiecoinAtStartup->setText(ui->yellowduckiecoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openYellowDuckieCoinConfButton->setToolTip(ui->openYellowDuckieCoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new YellowDuckieCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->yellowduckiecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openYellowDuckieCoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openYellowDuckieCoinConf())
