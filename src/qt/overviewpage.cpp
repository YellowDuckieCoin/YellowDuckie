...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(YellowDuckieCoinUnits::YD),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->ydBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->ydBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(YellowDuckieCoinUnits::formatWithUnit(unit, balance, false, YellowDuckieCoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(YellowDuckieCoinUnits::formatWithUnit(unit, unconfirmedBalance, false, YellowDuckieCoinUnits::separatorAlways));
    ui->labelImmature->setText(YellowDuckieCoinUnits::formatWithUnit(unit, immatureBalance, false, YellowDuckieCoinUnits::separatorAlways));
    ui->labelTotal->setText(YellowDuckieCoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, YellowDuckieCoinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(YellowDuckieCoinUnits::formatWithUnit(unit, watchOnlyBalance, false, YellowDuckieCoinUnits::separatorAlways));
    ui->labelWatchPending->setText(YellowDuckieCoinUnits::formatWithUnit(unit, watchUnconfBalance, false, YellowDuckieCoinUnits::separatorAlways));
    ui->labelWatchImmature->setText(YellowDuckieCoinUnits::formatWithUnit(unit, watchImmatureBalance, false, YellowDuckieCoinUnits::separatorAlways));
    ui->labelWatchTotal->setText(YellowDuckieCoinUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, YellowDuckieCoinUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("YD")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the YD balance grid from expanding and looking terrible when asset balance is hidden
