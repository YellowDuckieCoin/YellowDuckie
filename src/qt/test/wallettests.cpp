...
#include "qt/yellowduckiecoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<YellowDuckieCoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_yellowduckiecoin-qt -platform xcb      # Linux
//     src/qt/test/test_yellowduckiecoin-qt -platform windows  # Windows
//     src/qt/test/test_yellowduckiecoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = YellowDuckieCoinUnits::formatWithUnit(unit, balance, false, YellowDuckieCoinUnits::separatorAlways);
    ...
    // Amount input
    YellowDuckieCoinAmountField* amountInput = receiveCoinsDialog.findChild<YellowDuckieCoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: yellowduckiecoin:")) != -1);
