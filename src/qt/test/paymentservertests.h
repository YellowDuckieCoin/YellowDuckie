...
#ifndef YellowDuckieCoin_QT_TEST_PAYMENTSERVERTESTS_H
#define YellowDuckieCoin_QT_TEST_PAYMENTSERVERTESTS_H
...
#endif // YellowDuckieCoin_QT_TEST_PAYMENTSERVERTESTS_H
