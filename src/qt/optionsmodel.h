...
#ifndef YellowDuckieCoin_QT_OPTIONSMODEL_H
#define YellowDuckieCoin_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for YellowDuckieCoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // YellowDuckieCoinUnits::Unit
...
#endif // YellowDuckieCoin_QT_OPTIONSMODEL_H
