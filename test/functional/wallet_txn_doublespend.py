...
class TxnMallTest(YellowDuckieCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 YD:
        ...
        # First: use raw transaction API to send 1240 YD to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 YD coin each
        ...
        # Node0's balance should be starting balance, plus 50YD for another
        ...
        # Node0's total balance should be starting balance, plus 100YD for 
