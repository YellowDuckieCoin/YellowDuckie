...
class WalletTest(YellowDuckieCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 YD from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 YD with subtract fee from amount
        ...
        # Sendmany 10 YD with subtract fee from amount
