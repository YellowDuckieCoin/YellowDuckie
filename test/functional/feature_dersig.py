...
class BIP66Test(YellowDuckieCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # yellowduckiecoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and yellowduckiecoind produces more specific reject
            # reasons.
