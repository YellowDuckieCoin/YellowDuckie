...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the YellowDuckieCoinTestFramework
    pass

class ExampleTest(YellowDuckieCoinTestFramework):
    # Each functional test is a subclass of the YellowDuckieCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        YellowDuckieCoinTestFramework class so other tests can use it."""
