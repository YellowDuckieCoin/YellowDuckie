...
By default, yellowduckiecoind will dump mempool on shutdown and
...
class MempoolPersistTest(YellowDuckieCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give yellowduckiecoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent yellowduckiecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
