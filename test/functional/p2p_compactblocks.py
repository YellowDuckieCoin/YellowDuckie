...
# TestNode: A peer we use to send messages to yellowduckiecoind, and store responses.
...
class CompactBlocksTest(YellowDuckieCoinTestFramework):
    ...
    # This test actually causes yellowduckiecoind to (reasonably!) disconnect us, so do this last.
    ...
    # yellowduckiecoind's choice of nonce.
    ...
    # Test that yellowduckiecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for yellowduckiecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # yellowduckiecoind will not send blocktxn responses for blocks whose height is
