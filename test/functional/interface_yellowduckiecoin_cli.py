...
class TestYellowDuckieCoinCli(YellowDuckieCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `yellowduckiecoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `yellowduckiecoin-cli -getinfo` and the RPCs data is retrieved from.")
