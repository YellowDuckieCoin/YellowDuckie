...
class AssetTest(YellowDuckieCoinTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("YellowDuckieCoin1", 1000)
        n0.issue("YellowDuckieCoin2", 1000)
        n0.issue("YellowDuckieCoin3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="YellowDuckieCoin*", verbose=False, count=2, start=-2)
        ...
        yellowduckiecoin_assets = n0.listassets(asset="YellowDuckieCoin*", verbose=False, count=2, start=-2)
        assert_equal(len(yellowduckiecoin_assets), 2)
        assert_equal(yellowduckiecoin_assets[0], "YellowDuckieCoin2")
        assert_equal(yellowduckiecoin_assets[1], "YellowDuckieCoin3")
        self.sync_all()
