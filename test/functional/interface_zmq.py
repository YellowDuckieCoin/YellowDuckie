...
import os
import struct
from test_framework.test_framework import YellowDuckieCoinTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(YellowDuckieCoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that yellowduckiecoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("yellowduckiecoind has not been built with zmq enabled.")
